...
return [
    ...
    'settings' => [
        ...
        'enable_watermark_label' => 'Enable watermarking',
        'enable_watermark_comment' => 'Adds a logo to the image',
        'watermark_image_label' => 'Image',
        'watermark_invalid_image' => 'The watermark image field is required when watermark is enabled.',
    ],
    'permission' => [
        'tab' => 'Image Resizer',
